    ...
    <div align="center" style="margin-top: 5%">
        <%
            ...
            if(session.getAttribute("unitInfo")!=null){
                ...
                unitInfo[0] = unit.getUNITACCNUM();
                unitInfo[1] = unit.getUNITACCNAME();
                unitInfo[2] = unit.getUNITPROP();
                unitInfo[3] = unit.getPERPROP();
            }
        %>
        <form action="selfRegister" method="post" enctype="multipart/form-data">
            <div style="font-weight: bold;font-size: 20px;color: firebrick">建立个人账户</div><br>
            <div>
                <table>
                    <tr style="width: 100%">
                        <td>单位帐号：</td>
                        <td><input id="UnitNumber" name="UnitNumber" type="text" placeholder="<%=unitInfo[0]%>" onblur="autoInfo()"></td>
                        <script>
                            function autoInfo(){
                                let UnitNumber = document.getElementById("UnitNumber").value
                                window.location.href = "/selfReAutoView?unitNumber="+UnitNumber
                            }
                        </script>
                    </tr>
                    <tr style="width: 100%">
                        <td>单位名称：</td>
                        <td><input name="UnitName" type="text" placeholder="<%=unitInfo[1]%>"></td>
                    </tr>
                    <tr style="width: 100%">
                        <td>单位比例：</td>
                        <td><input name="UnitScale" type="text" placeholder="<%=unitInfo[2]%>"></td>
                    </tr>
                    <tr style="width: 100%">
                        <td>个人比例：</td>
                        <td><input name="SelfScale" type="text" placeholder="<%=unitInfo[3]%>"></td>
                    </tr>
                    <tr style="width: 100%">
                        <td>姓名：</td>
                    ...
                    <tr>
                        <td>证件号码:</td>
                        <td>
                            <input name="selfNumber" type="text">
                        </td>
                    </tr>
                    <tr>
                        <td>缴存基数:</td>
                        <td>
                            <input name="sendNumber" type="text">
                        </td>
                    </tr>
                    <tr>
                        <td>批量上传：</td>
