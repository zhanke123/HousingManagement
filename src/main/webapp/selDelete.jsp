...
<div id="choose">
    ...
    <div align="center" style="margin-top: 5%">
        <div align="center" style="font-size: 30px;color: firebrick;margin-bottom: 20px">个人信息</div>
        <table style="margin-left: 4%;margin-right: 4%">
            ...
            <c:forEach items="${selfList}" var="self" varStatus="id">
                <tr>
                    <td>${self.NAME}</td>
                    <td>${self.ACCNUM}</td>
                    <td>${self.SFZ}</td>
                    <td>${self.OPENDATE}</td>
                    <td><a href="/SelfDelete?selfNum=${self.ACCNUM}"><button>删除</button></a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
